    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-row :gutter="10" class="mb8">
          ...
          <el-col :span="1.5">
            <el-button type="info" icon="el-icon-download" size="mini" @click="handleImport"
                       v-hasPermi="['system:user:import']">导入</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="warning" icon="el-icon-upload2" size="mini" @click="handleExport" :loading="exportLoading"
  ...
  data() {
    return {
      ...
      rules: {
        ...
        mobile: [
          {
            pattern: /^(?:(?:\+|00)86)?1(?:(?:3[\d])|(?:4[5-79])|(?:5[0-35-9])|(?:6[5-7])|(?:7[0-8])|(?:8[\d])|(?:9[189]))\d{8}|((5|6|8|9)\d{7})$/,
            message: "请输入正确的手机号码",
            trigger: "blur"
          }
        ]
