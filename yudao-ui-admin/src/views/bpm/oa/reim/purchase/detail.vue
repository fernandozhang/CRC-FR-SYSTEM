<template>
  <div class="app-container">
    <!-- 对话框(添加 / 修改) -->
    <el-form ref="form" :model="form" label-width="10vw" label-position="left" label-suffix="：">
      <el-row>
        <el-col :span="12">
          <el-form-item label="报销编号" prop="id">
            {{ form.id }}
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="购买途径" prop="purBy">
            <dict-tag :type="DICT_TYPE.REIM_PURCHASE_WAY_TYPE" :value="form.purBy" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="货币种类" prop="totalUnit">
            <dict-tag :type="DICT_TYPE.REIM_PURCHASE_CURRENCY_TYPE" :value="form.totalUnit" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="备注" prop="remark" v-show="form.remerk != undefined && form.remerk">
            {{ form.remark }}
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item label="物品照片" prop="objsImg" v-if="form.objsImg != undefined && form.objsImg">
            <image-preview :src="form.objsImg" :width="192" :height="108" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="订单截图" prop="orderImg" v-if="form.orderImg != undefined && form.orderImg">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="付款记录截图" prop="payImg" v-if="form.payImg != undefined && form.payImg">
